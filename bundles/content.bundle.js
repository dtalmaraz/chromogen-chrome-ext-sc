...
window.addEventListener('message', function (message) { return chrome.runtime.sendMessage(message.data); });
chrome.runtime.onMessage.addListener(function (message) { return window.postMessage(message, '*'); });
